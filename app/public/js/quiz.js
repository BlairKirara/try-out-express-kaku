...
function displayQuestion() {
    ...
    if (questionCount <= 20) {
        ...
        document.getElementById("questionNumber").innerText = "Question " + questionCount + " of 20";
    } else {
        showScore();
    }
}
...
function showScore() {
    document.getElementById("question").innerText = "Quiz finished! Your score: " + correctCount + " out of 20";
