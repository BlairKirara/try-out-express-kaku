...
exports.getRadicalsList = async (req, res) => {
  try {
    ...
    const radicalsAdavnced = [
      ...
      { Radical: "", Reading: "あお", Meaning: "blue, green", Note: "a variant of ⾭（あお）" },
      { Radical: "⾮", Reading: "あらず", Meaning: "wrong, non-" },
      { Radical: "", Reading: "しょくへん", Meaning: "food, to eat", Note: "a variant of ⾷（しょく）" },
      { Radical: "", Reading: "せい", Meaning: "alike", Note: "a variant of ⿑（せい）" },
      ...
      { Radical: "", Reading: "うまへん", Meaning: "horse", Note: "a variant of ⾺（うま）" },
      { Radical: "⾻", Reading: "ほね", Meaning: "bone" },
      { Radical: "", Reading: "ほねへん", Meaning: "bone", Note: "a variant of ⾻（ほね）" },
      ...
      { Radical: "", Reading: "なめしがわ", Meaning: "leather", Note: "a variant of （なめしがわ）" },
      { Radical: "⿂", Reading: "うお", Meaning: "fish" },
      { Radical: "", Reading: "うおへん", Meaning: "fish", Note: "a variant of ⿂（うお）", Importance: "Important" },
      ...
      { Radical: "", Reading: "あさかんむり", Meaning: "hemp", Note: "a variant of ⿇（あさ）", Importance: "Important" },
      { Radical: "", Reading: "き", Meaning: "yellow", Note: "a variant of ⿈（き）" },
      { Radical: "", Reading: "くろ", Meaning: "black", Note: "a variant of ⿊（くろ）" },
      { Radical: "", Reading: "かめ", Meaning: "turtle", Note: "a variant of ⿔（かめ）" },
      ...
      { Radical: "", Reading: "は", Meaning: "tooth", Note: "a variant of ⿒（は）" },
